      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          ...
          <p
            ...
            data-aos={"fade-left"}
          >
            I love playing music, reading comics and playing games.I'm working in <a href="https://systemintegration.in/our-team/">BMV System Integration</a> from July 2022.
            I am {getDate()}{" "}
          ...
          >
            ...
            I worked on ReactJs, React Native, Google App Script.
